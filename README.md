Custom code for STM32F103T8 to create a small low-power control device that allws frame-based control of SPI leds (like WS2812, SK6812 and so on) and servos at the same time. 
